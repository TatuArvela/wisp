...
`,StatusBarSection=styled_components_browser_esm.iv`
  ...
  display: flex;
  align-items: center;
  flex-grow: ${_ref=>{let{width}=_ref;return void 0!==width?"unset":1}};
  font-family: sans-serif;
  font-size: 12px;
  padding: 2px;
...
//# sourceMappingURL=548.78785555.iframe.bundle.js.map