...
`,VersionInfo=styled_components_browser_esm.iv`
  ...
  user-select: none;
  z-index: 1000;
`,default_elements={...taskbar_namespaceObject,...taskbarButton_namespaceObject,...desktop_namespaceObject,...versionInfo_namespaceObject},default_icons={error:{48:__webpack_require__.p+"static/media/error.7fd7b111.png"},warning:{48:__webpack_require__.p+"static/media/warning.5d1b8921.png"},wisp:{48:__webpack_require__.p+"static/media/wisp.0b0bddc7.png"}},sharedStyle=styled_components_browser_esm.iv`
  box-sizing: border-box;
  position: absolute;
