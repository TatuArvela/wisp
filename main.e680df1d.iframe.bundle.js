...
`,AddressBarInputContainer=styled_components_browser_esm.iv`
  align-items: center;
  border-radius: 1px;
...
`,CheckboxLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,ComboBoxWrapper=styled_components_browser_esm.iv``,ComboBoxLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,ComboBoxControl=styled_components_browser_esm.iv`
  display: flex;
  position: relative;
  height: 100%;
  width: 100%;
...
`,Label=styled_components_browser_esm.iv`
  ...
  font-family: sans-serif;
  margin: 0;
`,ListBoxWrapper=styled_components_browser_esm.iv``,ListBoxLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,ListBoxControl=styled_components_browser_esm.iv`
  display: flex;
  position: relative;
  height: 100%;
  width: 100%;
...
`,ListBoxValue=styled_components_browser_esm.iv`
  align-items: center;
  border-bottom-left-radius: 1px;
  border-bottom: 1px solid ${props=>props.disabled?"gray":"black"};
  border-left: 1px solid ${props=>props.disabled?"gray":"black"};
  ...
  user-select: none;
  width: 100%;
`,ListBoxButton=styled_components_browser_esm.iv`
  background: white;
  border-top: 1px solid ${props=>props.disabled?"gray":"black"};
  border-right: 1px solid ${props=>props.disabled?"gray":"black"};
  border-bottom: 1px solid ${props=>props.disabled?"gray":"black"};
...
`,MenuBarThrobber=styled_components_browser_esm.iv`
  ...
  background-image: url('${props=>props.image??menuBarThrobberIcon_namespaceObject}');
...
`,StatusBarSection=styled_components_browser_esm.iv`
  ...
  font-size: 12px;
  padding: 2px;
`,TextareaWrapper=styled_components_browser_esm.iv``,TextareaLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,TextareaElement=styled_components_browser_esm.iv`
  border-radius: 1px;
  border: 1px solid ${props=>props.disabled?"gray":"black"};
  box-sizing: border-box;
  color: ${props=>props.disabled?"gray":"black"};
  ...
  outline: none;
  width: 100%;
`,TextInputWrapper=styled_components_browser_esm.iv``,TextInputLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,TextInputElement=styled_components_browser_esm.iv`
  border-radius: 1px;
  border: 1px solid ${props=>props.disabled?"gray":"black"};
  box-sizing: border-box;
  color: ${props=>props.disabled?"gray":"black"};
...
`,TimeInputWrapper=styled_components_browser_esm.iv``,TimeInputLabel=styled_components_browser_esm.iv`
  ${props=>props.theme.controls.Label}
`,TimeInputControl=styled_components_browser_esm.iv`
  display: flex;
  height: 24px;
  gap: 2px;
  width: 100%;
...
`,VersionInfo=styled_components_browser_esm.iv`
  ...
  user-select: none;
  z-index: 1000;
`,default_elements={...taskbar_namespaceObject,...taskbarButton_namespaceObject,...desktop_namespaceObject,...versionInfo_namespaceObject};var icons=__webpack_require__("./src/themes/default/icons/index.ts");const sharedStyle=styled_components_browser_esm.iv`
  box-sizing: border-box;
  position: absolute;
...
`,WindowElementContent=styled_components_browser_esm.iv`
  ...
  user-select: none;
  width: 100%;
`,theme={id:"DEFAULT",name:"Default Theme",controls:default_controls,elements:default_elements,window:{...resizeBorder_namespaceObject,...titleBar_namespaceObject,...titleBarButtons_namespaceObject,...window_namespaceObject,...windowElementContent_namespaceObject},icons:icons.Z}},"./stories lazy recursive ^\\.\\/.*$ include: (?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.tsx)$":(module,__unused_webpack_exports,__webpack_require__)=>{var map={"./AdvancedUsage.stories":["./stories/AdvancedUsage.stories.tsx",237,49],"./AdvancedUsage.stories.tsx":["./stories/AdvancedUsage.stories.tsx",237,49],"./Basics.stories":["./stories/Basics.stories.tsx",237,342],"./Basics.stories.tsx":["./stories/Basics.stories.tsx",237,342],"./Theming.stories":["./stories/Theming.stories.tsx",17,237,774],"./Theming.stories.tsx":["./stories/Theming.stories.tsx",17,237,774],"./controls/AddressBar.stories":["./stories/controls/AddressBar.stories.tsx",237,706],"./controls/AddressBar.stories.tsx":["./stories/controls/AddressBar.stories.tsx",237,706],"./controls/AlertText.stories":["./stories/controls/AlertText.stories.tsx",237,897],"./controls/AlertText.stories.tsx":["./stories/controls/AlertText.stories.tsx",237,897],"./controls/Button.stories":["./stories/controls/Button.stories.tsx",237,717],"./controls/Button.stories.tsx":["./stories/controls/Button.stories.tsx",237,717],"./controls/Checkbox.stories":["./stories/controls/Checkbox.stories.tsx",237,314],"./controls/Checkbox.stories.tsx":["./stories/controls/Checkbox.stories.tsx",237,314],"./controls/ComboBox.stories":["./stories/controls/ComboBox.stories.tsx",17,237,161],"./controls/ComboBox.stories.tsx":["./stories/controls/ComboBox.stories.tsx",17,237,161],"./controls/Divider.stories":["./stories/controls/Divider.stories.tsx",237,958],"./controls/Divider.stories.tsx":["./stories/controls/Divider.stories.tsx",237,958],"./controls/Fieldset.stories":["./stories/controls/Fieldset.stories.tsx",237,443],"./controls/Fieldset.stories.tsx":["./stories/controls/Fieldset.stories.tsx",237,443],"./controls/Label.stories":["./stories/controls/Label.stories.tsx",237,514],"./controls/Label.stories.tsx":["./stories/controls/Label.stories.tsx",237,514],"./controls/ListBox.stories":["./stories/controls/ListBox.stories.tsx",17,237,923],"./controls/ListBox.stories.tsx":["./stories/controls/ListBox.stories.tsx",17,237,923],"./controls/MenuBar.stories":["./stories/controls/MenuBar.stories.tsx",237,357],"./controls/MenuBar.stories.tsx":["./stories/controls/MenuBar.stories.tsx",237,357],"./controls/ProgressBar.stories":["./stories/controls/ProgressBar.stories.tsx",237,913],"./controls/ProgressBar.stories.tsx":["./stories/controls/ProgressBar.stories.tsx",237,913],"./controls/ScrollableContent.stories":["./stories/controls/ScrollableContent.stories.tsx",237,218],"./controls/ScrollableContent.stories.tsx":["./stories/controls/ScrollableContent.stories.tsx",237,218],"./controls/StatusBar.stories":["./stories/controls/StatusBar.stories.tsx",237,221],"./controls/StatusBar.stories.tsx":["./stories/controls/StatusBar.stories.tsx",237,221],"./controls/StatusBarSection.stories":["./stories/controls/StatusBarSection.stories.tsx",237,328],"./controls/StatusBarSection.stories.tsx":["./stories/controls/StatusBarSection.stories.tsx",237,328],"./controls/TextInput.stories":["./stories/controls/TextInput.stories.tsx",237,718],"./controls/TextInput.stories.tsx":["./stories/controls/TextInput.stories.tsx",237,718],"./controls/Textarea.stories":["./stories/controls/Textarea.stories.tsx",237,336],"./controls/Textarea.stories.tsx":["./stories/controls/Textarea.stories.tsx",237,336],"./controls/TimeInput.stories":["./stories/controls/TimeInput.stories.tsx",237,576],"./controls/TimeInput.stories.tsx":["./stories/controls/TimeInput.stories.tsx",237,576],"./controls/Toolbar.stories":["./stories/controls/Toolbar.stories.tsx",237,53],"./controls/Toolbar.stories.tsx":["./stories/controls/Toolbar.stories.tsx",237,53],"./controls/ToolbarButton.stories":["./stories/controls/ToolbarButton.stories.tsx",237,961],"./controls/ToolbarButton.stories.tsx":["./stories/controls/ToolbarButton.stories.tsx",237,961],"./controls/Well.stories":["./stories/controls/Well.stories.tsx",237,552],"./controls/Well.stories.tsx":["./stories/controls/Well.stories.tsx",237,552],"./controls/WindowContent.stories":["./stories/controls/WindowContent.stories.tsx",237,771],"./controls/WindowContent.stories.tsx":["./stories/controls/WindowContent.stories.tsx",237,771]};function webpackAsyncContext(req){if(!__webpack_require__.o(map,req))return Promise.resolve().then((()=>{var e=new Error("Cannot find module '"+req+"'");throw e.code="MODULE_NOT_FOUND",e}));var ids=map[req],id=ids[0];return Promise.all(ids.slice(1).map(__webpack_require__.e)).then((()=>__webpack_require__(id)))}webpackAsyncContext.keys=()=>Object.keys(map),webpackAsyncContext.id="./stories lazy recursive ^\\.\\/.*$ include: (?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.tsx)$",module.exports=webpackAsyncContext},"@storybook/channels":module=>{"use strict";module.exports=__STORYBOOK_MODULE_CHANNELS__},"@storybook/client-logger":module=>{"use strict";module.exports=__STORYBOOK_MODULE_CLIENT_LOGGER__},"@storybook/core-events":module=>{"use strict";module.exports=__STORYBOOK_MODULE_CORE_EVENTS__},"@storybook/global":module=>{"use strict";module.exports=__STORYBOOK_MODULE_GLOBAL__},"@storybook/preview-api":module=>{"use strict";module.exports=__STORYBOOK_MODULE_PREVIEW_API__}},__webpack_require__=>{__webpack_require__.O(0,[573],(()=>{return moduleId="./storybook-config-entry.js",__webpack_require__(__webpack_require__.s=moduleId);var moduleId}));__webpack_require__.O()}]);
//# sourceMappingURL=main.e680df1d.iframe.bundle.js.map