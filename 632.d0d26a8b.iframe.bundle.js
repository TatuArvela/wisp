...
`,StyledIcon=styled_components_browser_esm.ZP.img`
  ${props=>props.theme.elements.TaskbarButtonIcon}
`,Icon=_ref=>{let{icon}=_ref;if(!icon)return null;const iconFile=Object.entries(icon)[0][1];return(0,jsx_runtime.jsx)(StyledIcon,{src:iconFile,alt:"Window icon"})};Icon.displayName="Icon";const TaskbarButton=_ref2=>{let{active,icon,title,onClick}=_ref2;return(0,jsx_runtime.jsxs)(StyledTaskbarButton,{type:"button",active,onClick,children:[(0,jsx_runtime.jsx)(Icon,{icon}),(0,jsx_runtime.jsx)(Title,{children:title})]})};TaskbarButton.displayName="TaskbarButton";const Taskbar_TaskbarButton=TaskbarButton;try{TaskbarButton.displayName="TaskbarButton",TaskbarButton.__docgenInfo={description:"",displayName:"TaskbarButton",props:{active:{defaultValue:null,description:"",name:"active",required:!0,type:{name:"boolean"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"WindowIcon"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!0,type:{name:"() => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/elements/Taskbar/TaskbarButton.tsx#TaskbarButton"]={docgenInfo:TaskbarButton.__docgenInfo,name:"TaskbarButton",path:"src/elements/Taskbar/TaskbarButton.tsx#TaskbarButton"})}catch(__react_docgen_typescript_loader_error){}const TaskbarElement=styled_components_browser_esm.ZP.div`
...
`,TitleBar=styled_components_browser_esm.iv`
  ...
  user-select: none;
  width: 100%;
`,TitleContainer=styled_components_browser_esm.iv`
  display: flex;
  align-items: center;
  flex-grow: 1;
